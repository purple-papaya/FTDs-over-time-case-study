...
### Analysis Stage
**Objective**: Calculate client-level FTD metrics for live registrations, analyze temporal patterns, and forecast future FTD activity.

**Steps performed:**
1. Joined transactions, traders, and clients into a single dataset (filtered to Full and Light registrations only)
...
4. Compared FTD characteristics across registration types (Full, Light)
5. Tested moving average models (windows 3, 5, 7, 14, 21) on an 80/20 train-test split
6. Generated a 30-day rolling MA(3) forecast for daily FTD count and volume

**Key results:**
- 4,867 FTDs totaling $2.71M USD (avg $557, median $316)
- FTD conversion rate: 91.4% (4,867 / 5,325 clients)
- MA(3) best-fit model (MAE = 3.00, RMSE = 3.54)
- 30-day forecast: ~35 FTDs, ~$19K volume (converges to ~1.2 FTDs/day)
